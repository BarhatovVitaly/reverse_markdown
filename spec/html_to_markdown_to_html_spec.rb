...
describe 'Round trip: HTML to markdown (via reverse_markdown) to HTML (via redcarpet)' do
  ...
  def should_eq(input, target)
    markdown = ReverseMarkdown.convert(input)
    expect(markdown).to eq target
  end
  ...
  it "should preserve table without th" do
    should_eq("
      <table>
        <tr><td>Bird</td><td>1</td></tr>
        <tr><td>McHale</td><td>2</td></tr>
      </table>

      <table>
        <tr><td>Bird</td><td>2</td></tr>
        <tr><td>McHale</td><td>3</td></tr>
      </table>
    ",
    "| Bird | 1 |\n| --- | --- |\n| McHale | 2 |\n\n| Bird | 2 |\n| --- | --- |\n| McHale | 3 |\n\n"
    )
